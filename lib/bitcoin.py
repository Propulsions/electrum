...
def hash_160_to_bc_address(h160, addrtype = 239): #Darkcoin TESTNET private key type. Darkcoin/src/chainparams.cpp L139
...
def SecretToASecret(secret, compressed=False, addrtype= 239): #Darkcoin TESTNET private key type. Darkcoin/src/chainparams.cpp L139
    vchIn = chr((addrtype+128)&255) + secret
    if compressed: vchIn += '\01'
    return EncodeBase58Check(vchIn)

def ASecretToSecret(key, addrtype= 239): #Darkcoin TESTNET private key type. Darkcoin/src/chainparams.cpp L139
