...
DEFAULT_SERVERS = {
    'electrum-drk.be':DEFAULT_PORTS,
    'electrum-drk.drollette.com':{'t':'50001', 's':'50002'},
    'erbium1.sytes.net':{'t':'50001', 's':'50002'},
    'ecdsa.net':{'t':'50001', 's':'110'},
    'eco-electrum-drk.ddns.net':{'t': '50001', 's': '50002', 'h': '80', 'g': '443'},
    'electrum-drk0.electricnewyear.net':{'t':'50001', 's':'50002'},
    'kirsche.emzy.de':{'t':'50001', 's':'50002', 'h':'8081'},
    'electrum-drk2.hachre.de':DEFAULT_PORTS,
    'electrum-drk.hsmiths.com':DEFAULT_PORTS,
    'EAST.electrum-drk.jdubya.info':DEFAULT_PORTS,
    'WEST.electrum-drk.jdubya.info':DEFAULT_PORTS,
    'electrum-drk.no-ip.org':{'t':'50001', 's':'50002', 'h':'80', 'g':'443'},
    'electrum-drk.thwg.org':DEFAULT_PORTS,
    'us.electrum-drk.be':DEFAULT_PORTS,
}
